...
class NavCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Use fixedHeight for curve calculations instead of size.height
    final curveHeight = fixedHeight;
    ...
    final path = Path()
      ...
      ..cubicTo(
        ...
        curveHeight * 0.05, // topY
        size.width * loc, // bottomX
        curveHeight * bottom, // bottomY
        size.width * (loc + s * 0.5), // centerX
        curveHeight * bottom, // centerY
      )
      ..cubicTo(
